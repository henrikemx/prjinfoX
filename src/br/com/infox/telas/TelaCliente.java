...
public class TelaCliente extends javax.swing.JInternalFrame {
    ...
    // o método abaixo é para adiconar cliente na tabela tbclientes
    private void adicionar() {
        ...
        try {
            ...
            if ((txtCliNome.getText().isEmpty() || txtCliFone.getText().isEmpty())) {
                ...
                // a linha abaixo irá atualizar a tabela tbclientes com os dados inseridos no formulario
                // a estrutura abaixo é usada para confirmar a inserção de dados na tabela tbclientes
    ...
    // na linha abaixo será criado o método para pesquisar clientes pelo nome, com filtro
    private void pesquisar_cliente() {
        String sql = "select * from tbclientes where nomecli like ?";
        try {
            pst = conexao.prepareStatement(sql);
            // passando o conteudo da caixa de pesquisa para o ?
            // atenção com o "%" por se tratar de continuação da String sql
            pst.setString(1, txtCliPesquisar.getText() + "%");
            rs = pst.executeQuery();
            // a linha abaixo irá usar os recursos da biblioteca rs2xml.jar para preencher a tabela
    ...
    // o método abaixo irá preencher os campos do formulário com os dados da tabela
    ...
    private void initComponents() {
        ...
        txtCliId.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtCliFone, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtCliPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCliPesquisarKeyReleased
        // gera um evento "enquanto vai digitando"
        pesquisar_cliente();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        // este método irá alterar os dados na tabela tbclientes
        alterar();
