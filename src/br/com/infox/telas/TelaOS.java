...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    private void emitir_os() {
        ...
        try {
            ...
            // abaixo, a função .replace é usado para substituir a virgula pelo ponto
            pst.setString(7, txtOsValor.getText().replace(",", "."));
            pst.setString(8, txtCliId.getText());

            // validação dos campos obrigatórios
            if (txtCliId.getText().isEmpty() || txtOsEquip.getText().isEmpty() || txtOsDef.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Obrigatório o preenchimento!");
            } else {
    ...
    // método para pesquisar OS pelo seu numero
    private void pesquisar_os() {
        // a linha abaixo cria uma caixa de entrada do tipo JOptionPane
        String num_os = JOptionPane.showInputDialog("Informe nº da OS:");
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // abaixo seguem códigos para evitar problemas
    ...
    // o método abaixo irá alterar a tabela tbos
    ...
    // o método abaixo irá excluir registros na tabela tbos
    private void excluir_os() {
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza de que deseja ecluir esta OS ?", "Atenção !", JOptionPane.YES_NO_OPTION);
    ...
    private void imprimir_os() {
        // aqui será gerada toda a lógica de impressão de OS
        int confirma = JOptionPane.showConfirmDialog(null, "Confirma a impressão desse OS ?", "Atenção!", JOptionPane.YES_NO_OPTION);
        if (confirma == JOptionPane.YES_OPTION) {
            // aqui iremos imprimir o relatório com o Framework Jasper Reports
            try {
                // usando a classe HashMap para gerar um filtro
                HashMap filtro = new HashMap();
                filtro.put("os", Integer.parseInt(txtOs.getText()));
                // usando a classe JasperPrint para reparar a impressão de um relatório
                JasperPrint print = JasperFillManager.fillReport("/home/henrique/NetBeansProjects/backup/aulaEAD/prjinfoX/src/br/com/infox/ireport/os.jasper", filtro, conexao);
    ...
    private void initComponents() {
        ...
        cboOsSit.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Na bancada", "Entrega OK", "Orçamento REPROVADO", "Aguardando APROVAÇÃO", "Aguardando peça(s)", "Abandonado pelo cliente", "Retornou" }));
        ...
        btnOsExcluir.setToolTipText("Apagar OS");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtOsTec, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void rbtOrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOrcActionPerformed
        // atribuindo um texto à variavel tipo selecionado
        tipo = "Orçamento";
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // quando o form for aberto, irá habilitar, automaticamente, a opção Orçamento
        rbtOrc.setSelected(true);
        tipo = "Orçamento";
    }//GEN-LAST:event_formInternalFrameOpened

    private void btnOsAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsAdicionarActionPerformed
        // cadastrando um equipamento na tabela tbos
        emitir_os();
